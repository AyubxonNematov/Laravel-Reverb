...
const Chat = () => {
    ...
    const sendMessage = async (message, receiverId) => {
        try {
            const response = await axios.post('/messages', { message, receiverId });
                            ...
                            <div className="w-2/3 flex flex-col">
                                ...
                                <div className="p-4 border-t border-gray-200">
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <button onClick={sendMessage} className="px-4 py-2 bg-indigo-600 text-white rounded-r-md hover:bg-indigo-700">
                                            Send
                                        </button>
                                    </div>
                                </div>
